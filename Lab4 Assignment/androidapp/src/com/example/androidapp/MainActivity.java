	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		clk.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				webview.loadUrl("http://134.193.136.147:8080/HMMWS/jaxrs/generic/TrainFileOperation/-home-group8-gestures-ltor_Tej.txt/-home-group8-gestures-ltor_Tej.seq");
			    //connectSSH();
			}
		});
		...
		clk6.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				WebView webview = new WebView(MainActivity.this);
				setContentView(webview);
				webview.loadUrl("http://134.193.136.147:8080/HMMWS/jaxrs/generic/TrainFileOperation/-home-group8-gestures-rtol_Tej.txt/-home-group8-gestures-rtol_Tej.seq");
		...
		clk7.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				WebView webview = new WebView(MainActivity.this);
				setContentView(webview);
				webview.loadUrl("http://134.193.136.147:8080/HMMWS/jaxrs/generic/TrainFileOperation/-home-group8-gestures-ttob_Tej.txt/-home-group8-gestures-ttob_Tej.seq");
		...
		clk8.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				WebView webview = new WebView(MainActivity.this);
				setContentView(webview);
				webview.loadUrl("http://134.193.136.147:8080/HMMWS/jaxrs/generic/TestFileOperation/-home-group8-gestures-testfile_Tej.txt/-home-group8-gestures-testfile_Tej.seq");
		...
		clk9.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				WebView webview = new WebView(MainActivity.this);
				setContentView(webview);
				webview.loadUrl("http://134.193.136.147:8080/HMMWS/jaxrs/generic/HMMTrainingTestThree/-home-group8-gestures-ltor_Tej.seq/-home-group8-gestures-rtol_Tej.seq/-home-group8-gestures-ttob_Tej.seq/-home-group8-gestures-Combination_Tej.seq");
